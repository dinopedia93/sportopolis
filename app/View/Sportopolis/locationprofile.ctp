...
$(document).ready(function() {
    ...
    $("#rateBtn").click(function() {
        ...
        <?php } else { ?>
            alert('You must login in order to rate a location');
        <?php } ?>
    });
});
</script>
...
<?php if( true || ($this->Session->read('Auth.User.id') != $trainer['trainers']['user_id']) ) {?>
<div class="like-and-rate-title">Rate Me</div>
<!-- rating plugin -->
<div class="like-and-rate-right">
<div class="rating-f">
  <select id="example">
     <option <?php if( ($rating != null) && ($this->Session->read('Auth.User') != null) && ($rating['UsersRatingLocation']['rating'] == 1) )  { ?> selected <?php } ?> value="1"></option>
     <option <?php if( ($rating != null) && ($this->Session->read('Auth.User') != null) && ($rating['UsersRatingLocation']['rating'] == 2) )  { ?> selected <?php } ?> value="2"></option>
     <option <?php if( ($rating != null) && ($this->Session->read('Auth.User') != null) && ($rating['UsersRatingLocation']['rating'] == 3) )  { ?> selected <?php } ?> value="3"></option>
     <option <?php if( ($rating != null) && ($this->Session->read('Auth.User') != null) && ($rating['UsersRatingLocation']['rating'] == 4) )  { ?> selected <?php } ?> value="4"></option>
     <option <?php if( ($rating != null) && ($this->Session->read('Auth.User') != null) && ($rating['UsersRatingLocation']['rating'] == 5) )  { ?> selected <?php } ?> value="5"></option>
  </select>
</div>
