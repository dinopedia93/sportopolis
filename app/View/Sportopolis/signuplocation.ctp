...
<div class="signup-header-ai">Sign Up as a location owner</div>
</div>
...
<form class="signup-email" method="post" action="/sportopolis/sportopolis/RegisterLocation">
...
<input class="textboxStandard" type="password" name="password_confirmation" placeholder="Confirm Password">
