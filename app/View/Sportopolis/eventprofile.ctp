...
$(document).ready(function() {
    ...
    $(".rightbtn").click(function() {
     ...
     $.ajax({
            dataType: "html",
            type: "post",
            url: "<?php echo Router::url(array('controller'=>'sportopolis','action'=>'IncreaseEventViews'));?>",
...
<div class="profileNameLeftLargeContainer"><?php echo $event['Event']['name']; ?></div>
<div class="profileProfessionLeftLargeContainer">ay event</div>

<div class="profileViewsReviews">
<div class="profilePictoViewsReviews"><?php echo $this->Html->image('views.png'); ?></div>
<div class="profileNumViewsReviews"><?php echo $event['Event']['views']; ?></div>
<div class="profilePictoViewsReviews2"><?php echo $this->Html->image('like.png'); ?></div>
<div class="profileNumViewsReviews"><?php  echo "0"?></div>
</div>
...
<div class="rightLargeNavCount"><?php  echo "0"?></div>
</div>
